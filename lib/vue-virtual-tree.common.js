  ...
  setup: function setup(props, _ref) {
    ...
    var renderLine = function renderLine() {
      ...
      return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])("section", {
        ...
        "style": {
          top: "".concat(props.size / 2, "px"),
          left: "".concat(props.node.level * props.nodeOffsetBase - props.nodeOffsetBase / 2, "px"),
          width: props.node.hasChildren ? "".concat(props.nodeOffsetBase / 2, "px") : "".concat(props.nodeOffsetBase, "px")
        }
      }, null)]);
    };
    ...
    return function () {
      return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])("div", {
        ...
        "onClick": handleSelect
      }, [renderLine(), renderArrow(), renderContent()]);
    };
  }
}));
