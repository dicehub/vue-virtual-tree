  ...
  setup: function setup(props, _ref) {
    ...
    var renderArrow = function renderArrow() {
      return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])("div", {
        ...
        "onClick": Object(external_commonjs_vue_commonjs2_vue_root_Vue_["withModifiers"])(handleExpand, ['stop'])
      }, [props.node.hasChildren ? props.iconSlot ? props.iconSlot(props.node) : props.node.loading ? Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])("i", {
    ...
    var renderLines = function renderLines() {
      ...
      for (var lineCounter = 0; lineCounter < props.node.level; lineCounter++) {
        listLines.push(Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])("div", {
          "class": ['node-line'],
          "style": {
      ...
      return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])("section", {
        ...
        "class": ['node-line-list'],
        "style": {
          height: props.node.last ? "".concat(props.size / 2 - 1, "px") : "".concat(props.size, "px")
        }
      }, [listLines]), Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])("div", {
        "class": ['node-line-connector'],
        "style": {
          top: "".concat(props.size / 2 - 1, "px"),
          left: "".concat((props.node.level - 0.7) * props.nodeOffsetBase, "px"),
          width: "".concat(props.nodeOffsetBase / 2, "px")
        }
      }, null)]);
    };
    ...
    return function () {
      return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])("div", {
        "class": "vir-tree-node",
        "style": {
          paddingLeft: props.node.level * props.nodeOffsetBase + 'px'
        },
        "onClick": handleSelect
      }, [renderLines(), renderArrow(), renderContent()]);
    };
  }
}));
...
/* harmony default export */ var components_VirtualTree = (Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineComponent"])({
  ...
  setup: function setup(props, _ref) {
    ...
    var selectChange = function selectChange(node) {
      if (selectedKey.value) {
        if (selectedKey.value === node.nodeKey) {
          ...
          var prevSelectedNode = flatList.value.find(function (item) {
    ...
    var expandNode = function expandNode(node) {
      ...
      node.children = trueChildren.map(function (item, index) {
        var _item$checked;
